...
# =============================== PER-FORK CONFIG ===============================
# Fleet tag: bagE
BASE_SEED = 4            # BagMLP derives member seeds = BASE_SEED*100 + i + 1
HIDDEN_SIZES = (448, 224, 112)      # MLP hidden-layer widths (per member)
DROPOUT = 0.3             # dropout between hidden layers
...
def main():
    print(
        "[config] fleet=bagE arch=%s dropout=%s base_seed=%d n_members=%d"
